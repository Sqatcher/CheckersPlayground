...
public class Main {
    ...
    private static int movePossible(char currentPlayer, char[][] board, int x0, int y0, int x, int y) // -1 = false, 1 = move by 1, 2 = move by 2
    {
    ...
    private static boolean isWon(char enemyPlayer, char[][] board)
    {
    ...
    private static boolean canAttack(char currentPlayer, char[][] board)
    {
    ...
    private static char[][] makeMoveBy1(char[][] board, int x0, int y0, int x, int y)
    {
    ...
    private static char[][] makeMoveBy2(char[][] board, int x0, int y0, int x, int y)
    {
    ...
    private static int[] canPieceAttack(char myColour, char[][] board, int x0, int y0)
    {
        int[] xy = {0, 0};
    ...
    private static class CheckerBot
    {
        ...
        // moves[0] = "0.0"
        private static String[] getMove(char myColour, char[][] board, int r)
        {
            int MAX_R = 8;
            char enemyColour = (myColour == 'b') ? 'w' : 'b';
            char myKing = Character.toUpperCase(myColour);
